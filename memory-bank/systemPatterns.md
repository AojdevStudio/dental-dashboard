...
### 1. Data Layer
- **Responsibilities:** Database schema management (Prisma), data access and manipulation (Repositories), Google Sheets API integration, data transformation and normalization, caching.
- **Key Sub-Components:**
    ...
    - `Google Sheets Connector Services`: Handles authentication, discovery, and data extraction from Google Sheets.
...
1.  **Data Ingestion (Google Sheets):**
    ...
    *   `Google Sheets Connector Service` lists available spreadsheets.
